...
namespace DS {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TableRow AddTableRow(int Id, string Name, string ZipCode, string Address, string Tel) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string ZipCode {
                get {
                    try {
                        return ((string)(this[this.tableTable.ZipCodeColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("テーブル \'Table\' にある列 \'ZipCode\' の値は DBNull です。", e);
                    }
                }
                set {
                    this[this.tableTable.ZipCodeColumn] = value;
                }
            }
            ...
            public bool IsZipCodeNull() {
                return this.IsNull(this.tableTable.ZipCodeColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetZipCodeNull() {
                this[this.tableTable.ZipCodeColumn] = global::System.Convert.DBNull;
            }
...
namespace DS.Database1DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ((@IsNull_ZipCode = 1 AND [ZipCode] IS NULL) OR ([ZipCode] = @Original_ZipCode)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Tel = 1 AND [Tel] IS NULL) OR ([Tel] = @Original_Tel)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [Name], [ZipCode], [Address], [Tel]) VALUES (@Id" +
                ", @Name, @ZipCode, @Address, @Tel);\r\nSELECT Id, Name, ZipCode, Address, Tel FROM" +
                " [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [Name] = @Name, [ZipCode] = @ZipCode, [Address] = @Address, [Tel] = @Tel WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ((@IsNull_ZipCode = 1 AND [ZipCode] IS NULL) OR ([ZipCode] = @Original_ZipCode)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Tel = 1 AND [Tel] IS NULL) OR ([Tel] = @Original_Tel)));
SELECT Id, Name, ZipCode, Address, Tel FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DS.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, ZipCode, Address, Tel FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_ZipCode, string Original_Address, string Original_Tel) {
            ...
            if ((Original_ZipCode == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[3].Value = ((string)(Original_ZipCode));
            }
        ...
        public virtual int Insert(int Id, string Name, string ZipCode, string Address, string Tel) {
        ...
        public virtual int Update(int Id, string Name, string ZipCode, string Address, string Tel, int Original_Id, string Original_Name, string Original_ZipCode, string Original_Address, string Original_Tel) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string ZipCode, string Address, string Tel, int Original_Id, string Original_Name, string Original_ZipCode, string Original_Address, string Original_Tel) {
            return this.Update(Original_Id, Name, ZipCode, Address, Tel, Original_Id, Original_Name, Original_ZipCode, Original_Address, Original_Tel);
        }
    }
